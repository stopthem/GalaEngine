...
SpriteComponent::SpriteComponent(std::string imageAssetId, const int width, const int height, const int zIndex, const bool isFixed, const bool render0Angle, const glm::vec2 srcPos)
