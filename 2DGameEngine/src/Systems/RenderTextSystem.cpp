...
namespace gala
{
    ...
    {
        SDL_Surface* surface = TTF_RenderText_Blended(AssetStorePtr->GetFont(textComponentParams.FontFilePath, textComponentParams.FontSize), textComponentParams.Text.c_str(), textComponentParams.Color.AsSDLColor());
