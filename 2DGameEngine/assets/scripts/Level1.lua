...
Level = {
    ...
    assets = {
        ...
        { type = "font"   , id = "pico8-font-16",               file = "./assets/fonts/pico8.ttf", font_size = 16 }
    },
            ...
            components = {
                ...
                on_update_script = {
                    ...
                    function(entity, delta_time, ellapsed_time)
                        ...
                        local current_location_x, current_location_y = get_location(entity)
                        local current_velocity_x, current_velocity_y = get_velocity(entity)

                        -- if it reaches the top or the bottom of the map
                        if current_location_y < 10  or current_location_y > map_height - 32 then
